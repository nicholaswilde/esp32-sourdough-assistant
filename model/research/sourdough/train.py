...
def main():
    ...
    parser.add_argument("--steps", type=int, default=3000, help="Total training steps (default: 3000)")
    parser.add_argument("--lr", type=float, default=1e-3, help="Learning rate (default: 1e-3)")
    parser.add_argument("--warmup", type=int, default=200, help="Warmup steps (default: 200)")
